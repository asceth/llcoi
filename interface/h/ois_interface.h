...
DLL int keyboard_is_modifier_down(CoiHandle keyboard_handle, enum Key_Modifier key_modifier);

DLL MouseState mouse_get_state(CoiHandle mouse_handle);

DLL void mouse_set_buffered(CoiHandle mouse_handle, int buffered);

DLL void keyboard_set_buffered(CoiHandle keyboard_handle, int buffered);
