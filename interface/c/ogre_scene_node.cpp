...
void scene_node_attach_entity(CoiHandle scene_node_handle, CoiHandle entity_handle)
{
    ...
    Ogre::SceneNode* scene_node = reinterpret_cast<Ogre::SceneNode*>(scene_node_handle);
...
{
    Ogre::SceneManager* scene_manager = reinterpret_cast<Ogre::SceneNode*>(scene_node_handle)->getCreator();
