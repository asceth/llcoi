...
CoiHandle create_scene_manager(const char* type_name, const char* instance_name)
{
...
CoiHandle get_scene_manager()
{
    return Ogre::Root::getSingletonPtr()->getSceneManager(OgreManager::getSingletonPtr()->get_active_scene_manager_name());
}

CoiHandle get_scene_manager_by_name(const char* scene_manager_instance_name)
{
    return Ogre::Root::getSingletonPtr()->getSceneManager(scene_manager_instance_name);
}

// Ogre::SceneManager::setAmbientLight(Ogre::ColourValue const&)
void scene_manager_set_ambient_light_rgba(CoiHandle scene_manager_handle, const float r, const float g, const float b, const float a)
{
...
void scene_manager_set_ambient_light_rgb(CoiHandle scene_manager_handle, const float r, const float g, const float b)
{
  Ogre::SceneManager* scene_manager = reinterpret_cast<Ogre::SceneManager*>(scene_manager_handle);
  scene_manager->setAmbientLight(Ogre::ColourValue(r, g, b));
}
// Ogre::SceneManager::getAmbientLight()
coiColourValue scene_manager_get_ambient_light(CoiHandle scene_manager_handle)
{
  Ogre::SceneManager* scene_manager = reinterpret_cast<Ogre::SceneManager*>(scene_manager_handle);
  return ogre_colour_to_llcoi_colour(scene_manager->getAmbientLight());
}


// Ogre::SceneManager::setShadowTechnique(Ogre::ShadowTechnique)
void scene_manager_set_shadow_technique(CoiHandle scene_manager_handle, const int technique)
{
  Ogre::SceneManager* scene_manager = reinterpret_cast<Ogre::SceneManager*>(scene_manager_handle);
