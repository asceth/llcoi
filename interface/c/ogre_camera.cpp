...
CoiHandle create_camera(CoiHandle scene_manager_handle, const char* camera_name)
{
...
CoiHandle get_camera(CoiHandle scene_manager_handle, const char* camera_name)
{
  Ogre::SceneManager* scene_manager = reinterpret_cast<Ogre::SceneManager*>(scene_manager_handle);
...
void camera_set_near_clip_distance(CoiHandle camera_handle, float d)
{
...
void camera_set_aspect_ratio(CoiHandle camera_handle, float w, float h)
{
    Ogre::Camera* camera = reinterpret_cast<Ogre::Camera*>(camera_handle);
    camera->setAspectRatio(Ogre::Real(Ogre::Real(w)/Ogre::Real(h)));
}

void camera_set_auto_aspect_ratio(CoiHandle camera_handle, bool on)
{
    Ogre::Camera* camera = reinterpret_cast<Ogre::Camera*>(camera_handle);
...
void camera_set_frustum_offset(CoiHandle camera_handle, const int offset_x, const int offset_y)
{
    Ogre::Camera* camera = reinterpret_cast<Ogre::Camera*>(camera_handle);
    camera->setFrustumOffset(Ogre::Vector2(offset_x, offset_y));
}

void camera_set_focal_length(CoiHandle camera_handle, float fl)
{
    Ogre::Camera* camera = reinterpret_cast<Ogre::Camera*>(camera_handle);
...
void camera_set_position(CoiHandle camera_handle, const float x, const float y, const float z)
{
    Ogre::Camera* camera = reinterpret_cast<Ogre::Camera*>(camera_handle);
